...
export default function App() {
    const sounds: { title: string; url: string }[] = [
        { title: 'Order Filled', url: 'https://github.com/ayoubdlf/TradingView-Custom-Alert-Sound/raw/refs/heads/main/orderFilled.mp3' },
        { title: 'Goat', url: 'https://github.com/ayoubdlf/TradingView-Custom-Alert-Sound/raw/refs/heads/main/goat.mp3' },
    ]
